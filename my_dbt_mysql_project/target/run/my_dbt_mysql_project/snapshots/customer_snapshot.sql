          ...
          insert into `dbt_test_airflow_snapshots`.`customers_snapshot` (`customer_id`, `name`, `tier`, `updated_at`, `dbt_updated_at`, `dbt_valid_from`, `dbt_valid_to`, `dbt_scd_id`)
    ...
    from `dbt_test_airflow_snapshots`.`customers_snapshot__dbt_tmp` as DBT_INTERNAL_SOURCE
